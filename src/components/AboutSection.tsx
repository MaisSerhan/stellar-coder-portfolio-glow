          ...
          <div className="animate-fade-in">
            <div className="relative w-full max-w-md mx-auto aspect-[3/4] bg-gradient-to-br from-tech-purple to-tech-teal rounded-lg overflow-hidden shadow-xl">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <p className="text-white text-lg font-medium"><img src="https://github.com/MaisSerhan/MaisSarhan/blob/main/static/photo/image.png?raw=true"></img>Profile Photo</p>
              </div>
              {/* Decorative elements */}
